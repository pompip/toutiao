...
public abstract class BaseApi<T> implements Func1<BaseResultEntity<T>, T>{
    ...
    //这里是一个正式的
    //private String baseUrl = "http://huanxifin.com/api/index.php/news/";
...
//    private static final String RELEASE_URL="http://118.31.4.145/html/hxtoutiao/public/api/news/";
 private static final String DEBUG_URL="http://118.31.8.92/api/news/";
    private static final String RELEASE_URL="http://118.31.8.92/api/news/";
